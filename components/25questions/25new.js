...
import SimpleButton from "../SimpleButton"; // update when moved to pages
import Avatar from "../Avatar";
import styles from "../../styles/Settings.module.css"; // same css as 2T1L, update when moved to pages
import Error from "../Error"; // update when moved to pages
import { motion } from "framer-motion";
var mixpanel = require("mixpanel-browser");

/*This file is for the Settings component for 25 Qs
@Michael*/
      ...
      {(!chrome && !firefox) || mobile ? (
        ...
        <div>
          ...
          <header>
            ...
            <h1>HOST A GAME OF 25 QUESTIONS!</h1>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.settingsForm} id="settings-form">
              ...
              />
              <b>
                <label htmlFor="rounds">Number of Rounds (1-10): </label>
                    </b>
                    <input
                        className={styles.settingsInput}
                        type="number"
